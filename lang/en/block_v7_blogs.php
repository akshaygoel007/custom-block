...
/**
 * Strings for component 'block_v7_blogs', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['configtitle'] = 'Blogs';
$string['v7_blogs:addinstance'] = 'Blogs';
$string['v7_blogs:myaddinstance'] = 'Add a new HTML block to Dashboard';
$string['newv7blogsblock'] = 'Blogs';
$string['pluginname'] = 'V7 Blogs';
$string['search:content'] = 'Blogs block content';
